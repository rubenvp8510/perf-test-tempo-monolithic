...
.PHONY: help perf-test perf-test-quick ensure-monitoring deploy-tempo deploy-stack \
        gen stop-gen pods status clean build-push-gen generate-charts install-chart-deps
...
clean-results:
	...
	rm -rf ./perf-tests/results/raw/*.json
